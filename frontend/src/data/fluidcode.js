...
export const videoPrompts = [
  {
    id: "video-scanner-pool",
    title: "Gancho comercial",
    asset: publicAsset("/fluidcode/generated/video-scanner-pool.png"),
    size: "1536x864",
    quality: "high",
    prompt:
      "Use case: ads-marketing. Asset type: cinematic frame for a FluidCode 30-second promotional video. Primary request: photorealistic aerial satellite-like view of an invented upscale residential house with an empty backyard being scanned by a subtle luminous cyan line, with a semi-transparent ultra-realistic rectangular pool proposal emerging in the yard. Scene/backdrop: generic suburban property, not a real map screenshot. Composition/framing: wide 16:9, top-down three-quarter aerial angle, enough negative space for overlay text, premium commercial quality. Lighting/mood: bright realistic daytime, technology-enabled, credible. Constraints: original synthetic property only, no readable text, no logos, no real addresses, no street names, no map UI, no watermark, no people.",
  },
  {
    id: "video-mobile-qr-gallery",
    title: "Experiência do cliente",
    asset: publicAsset("/fluidcode/generated/video-mobile-qr-gallery.png"),
    size: "1536x864",
    quality: "high",
    prompt:
      "Use case: ads-marketing. Asset type: cinematic frame for a FluidCode 30-second promotional video. Primary request: photorealistic close view of a client's hand holding a modern smartphone opened to an exclusive pool proposal page, with a QR code card nearby on a desk, and a gallery of personalized backyard pool images visible as abstract thumbnails on the phone. Scene/backdrop: premium sales table with architectural samples and soft daylight. Composition/framing: wide 16:9, phone dominant on right, QR material and desk context on left, polished B2B presentation. Lighting/mood: trustworthy, high-end, consultative. Constraints: no readable text, no real logos, no real QR functionality required, no watermark, no distorted hands, no copied UI.",
  },
  {
    id: "video-qualified-lead",
    title: "Poder comercial",
    asset: publicAsset("/fluidcode/generated/video-qualified-lead.png"),
    size: "1536x864",
    quality: "high",
    prompt:
      "Use case: ads-marketing. Asset type: cinematic frame for a FluidCode 30-second promotional video. Primary request: split-screen commercial visualization; left side shows a customer tapping a premium button on a phone concept to request a pool quote, right side shows a modern SaaS dashboard lighting up with a new qualified lead, visual history thumbnails, campaign status and sales pipeline. Scene/backdrop: dark professional sales operations environment. Composition/framing: wide 16:9 split-screen, phone on left, dashboard on right, dynamic glow accent. Lighting/mood: conversion moment, high-tech, executive. Constraints: no readable text, no real logos, no real addresses, no watermark, no cluttered fantasy UI.",
  },
  {
    id: "video-sunset-cta",
    title: "Chamada final",
    asset: publicAsset("/fluidcode/generated/video-sunset-cta.png"),
    size: "1536x864",
    quality: "high",
    prompt:
      "Use case: ads-marketing. Asset type: cinematic final frame for a FluidCode 30-second promotional video. Primary request: photorealistic luxury backyard pool completed at sunset, turquoise water glowing, warm sky, elegant deck, lounge furniture, subtle landscape lights and refined outdoor living area, with clean dark negative space in the center-top for brand/title overlay. Scene/backdrop: invented premium residential house, not a mansion, realistic high-value pool project. Composition/framing: wide 16:9 hero frame, cinematic, aspirational, no people. Lighting/mood: golden hour, emotional, premium, ready-to-buy. Constraints: no readable text, no logos, no watermark, no impossible architecture.",
  },
];
...
export const videoScript = [
  {
    time: "00-06s",
    scene: "Imagem aérea do quintal vazio com scanner visual e piscina surgindo no terreno.",
    voice:
      "Seu cliente consegue imaginar uma piscina pronta antes mesmo da primeira visita? Com a FluidCode, cada endereço vira desejo imediato.",
  },
  {
    time: "06-14s",
    scene: "Cliente abre uma página exclusiva por QR Code e navega pela galeria do próprio terreno.",
    voice:
      "A sua empresa envia um link exclusivo. O cliente acessa, vê o projeto ganhar vida no próprio terreno e envia os dados para orçamento.",
  },
  {
    time: "14-22s",
    scene: "Cliente solicita a piscina e o painel FluidCode recebe um novo lead qualificado.",
    voice:
      "O seu time comercial recebe leads prontos, com contexto, intenção de compra e imagens que tornam o fechamento muito mais rápido.",
  },
  {
    time: "22-30s",
    scene: "Piscina pronta ao pôr do sol com chamada final da FluidCode.",
    voice:
      "Pare de vender espaços vazios. FluidCode: transforme endereços simples em propostas visuais com Inteligência Artificial. Teste agora.",
  },
];
